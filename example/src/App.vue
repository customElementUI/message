    ...
    <div id="app">
        ...
        <demonstration
            ...
            <template slot="explanation">
                ...
                默认情况下，经过一段时间后 <code>Message</code> 组件会自动关闭，但是通过设置 <code>duration</code>，可以控制关闭的时间间隔，特别的是，如果设置为
                <code>0</code>，则不会自动关闭。
        ...
        <demonstration
                :show-content="false">
            <p>示例使用详情请参考：（<a href="https://github.com/savoygu/vue-demonstration">https://github.com/savoygu/vue-demonstration</a>）
            </p>
        </demonstration>
    </div>
</template>
